...
class WorkerHistory extends StatefulWidget {
  ...
  @override
  State<WorkerHistory> createState() => _UserHistoryState();
}

class _UserHistoryState extends State<WorkerHistory> {
  ...
  Future<List<BookingModel>> _getMyBookingHistory() async {
    try {
      return await BookingService.getWorkerBookingHistory(context: context);
    } catch (e) {
      rethrow;
    }
  }
